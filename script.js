...
// console.log("initializeAudio called. Current audioInitialized state:", audioInitialized);
if (audioInitialized) {
    // console.log("Audio already initialized, exiting initializeAudio.");
    return;
}
...
// } else {
//     console.log("Tone.context is not yet available BEFORE Tone.start().");
// }

try {
    // console.log("Attempting Tone.start()...");
    await Tone.start(); 
    // console.log("Tone.start() promise resolved. Tone.context.state AFTER Tone.start():", Tone.context.state);
    ...
    if (Tone.context.state === "running") {
        ...
        // console.log("playerShootSound initialized:", !!playerShootSound);
        ...
        // console.log("enemyExplosionSound initialized:", !!enemyExplosionSound);
        ...
        // console.log("powerUpSound initialized:", !!powerUpSound);
        ...
        // console.log("playerHitSound initialized:", !!playerHitSound);
    } else {
        // console.warn("Tone.start() completed, but AudioContext is not in 'running' state. Current state:", Tone.context.state);
    }
...
if (audioInitialized && playerShootSound) {
    try {
        ...
        // console.error("Error playing playerShootSound:", e); // エラー時のみログ出力
    }
}
}
            ...
            if (enemy.health <= 0) {
                ...
                if (audioInitialized && enemyExplosionSound) {
                    try {
                        ...
                        // console.error("Error playing enemyExplosionSound:", e);
                    }
                }
    ...
    if (dist < player.width / 2 + item.radius) {
        ...
        if (audioInitialized && powerUpSound) {
            try {
                ...
                // console.error("Error playing powerUpSound:", e);
            }
        }
    }
}
...
if (audioInitialized && playerHitSound) {
    try {
        ...
        // console.error("Error playing playerHitSound:", e);
    }
}
